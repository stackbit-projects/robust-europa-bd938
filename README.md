...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fdbd938488d050015e113bf
...
To start editing your site, you can use the Sanity interface at https://robust-europa-bd938.sanity.studio/.
...
Generated at `2020-12-17T22:19:10.612Z` by Stackbit version `0.3.40`.